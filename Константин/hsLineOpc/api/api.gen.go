...
type ServerInterface interface {
	...
	// (POST /default)
	PostDefault(w http.ResponseWriter, r *http.Request)
	// Запуск установки
	// (POST /start)
...
// PostDefault operation middleware
func (siw *ServerInterfaceWrapper) PostDefault(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PostDefault(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("POST "+options.BaseURL+"/default", wrapper.PostDefault)
	m.HandleFunc("POST "+options.BaseURL+"/start", wrapper.PostStart)
	m.HandleFunc("POST "+options.BaseURL+"/stop", wrapper.PostStop)
